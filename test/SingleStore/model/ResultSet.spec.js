...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SingleStoreClient.ResultSet();
  });
  ...
  describe('ResultSet', function() {
    it('should create an instance of ResultSet', function() {
      ...
      //var instane = new SingleStoreClient.ResultSet();
      //expect(instance).to.be.a(SingleStoreClient.ResultSet);
    });

    it('should have the property rows (base name: "rows")', function() {
      // uncomment below and update the code to test the property rows
      //var instance = new SingleStoreClient.ResultSet();
