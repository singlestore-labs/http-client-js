...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SingleStoreClient.QueryInput();
  });
  ...
  describe('QueryInput', function() {
    it('should create an instance of QueryInput', function() {
      ...
      //var instane = new SingleStoreClient.QueryInput();
      //expect(instance).to.be.a(SingleStoreClient.QueryInput);
    });

    it('should have the property sql (base name: "sql")', function() {
      // uncomment below and update the code to test the property sql
      //var instance = new SingleStoreClient.QueryInput();
