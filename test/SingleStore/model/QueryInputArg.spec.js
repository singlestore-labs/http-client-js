...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SingleStoreClient.QueryInputArg();
  });
  ...
  describe('QueryInputArg', function() {
    it('should create an instance of QueryInputArg', function() {
      // uncomment below and update the code to test QueryInputArg
      //var instane = new SingleStoreClient.QueryInputArg();
      //expect(instance).to.be.a(SingleStoreClient.QueryInputArg);
    });
