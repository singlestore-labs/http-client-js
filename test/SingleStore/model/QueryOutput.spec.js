...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SingleStoreClient.QueryOutput();
  });
  ...
  describe('QueryOutput', function() {
    it('should create an instance of QueryOutput', function() {
      // uncomment below and update the code to test QueryOutput
      //var instane = new SingleStoreClient.QueryOutput();
      //expect(instance).to.be.a(SingleStoreClient.QueryOutput);
    });

    it('should have the property results (base name: "results")', function() {
      // uncomment below and update the code to test the property results
      //var instance = new SingleStoreClient.QueryOutput();
