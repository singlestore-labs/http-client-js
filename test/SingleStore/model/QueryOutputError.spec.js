...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SingleStoreClient.QueryOutputError();
  });
  ...
  describe('QueryOutputError', function() {
    it('should create an instance of QueryOutputError', function() {
      // uncomment below and update the code to test QueryOutputError
      //var instane = new SingleStoreClient.QueryOutputError();
      //expect(instance).to.be.a(SingleStoreClient.QueryOutputError);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new SingleStoreClient.QueryOutputError();
