...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SingleStoreClient.StreamResult();
  });
  ...
  describe('StreamResult', function() {
    it('should create an instance of StreamResult', function() {
      // uncomment below and update the code to test StreamResult
      //var instane = new SingleStoreClient.StreamResult();
      //expect(instance).to.be.a(SingleStoreClient.StreamResult);
    });

    it('should have the property rows (base name: "rows")', function() {
      // uncomment below and update the code to test the property rows
      //var instance = new SingleStoreClient.StreamResult();
