...
* @alias module:SingleStore/ApiClient
* @class
*/
class ApiClient {
    constructor() {
    ...
    * @param {module:SingleStore/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:SingleStore/ApiClient}
*/
